    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-end m-2 p-2">
                <a href="{{ route('admin.packages.create') }}" class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">New Packages</a>
            </div>
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        @foreach ($packages as $package)
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-4 py-2 bg-green hover:bg-green-400 rounded-lg text-black"><a href="{{ route('admin.packages.edit', $package->id) }}"
